...
.hero-tagline {
    ...
    margin: 0.6rem 0 1.75rem; letter-spacing: 0.02em;
}
.hero-divider {
    display: flex; align-items: center; justify-content: center;
    gap: 0.75rem; margin: 0 auto 0;
}
.hero-divider-line {
...
.dest-name {
    ...
    color: #f0ece2; margin: 0 0 0.25rem;
}
.dest-meta {
...
.how-card {
    background: var(--surface);
    border: 1px solid var(--border);
    border-radius: 14px; padding: 1.4rem 1.1rem 1.3rem;
    text-align: center;
    transition: border-color 0.2s, transform 0.2s;
}
.how-card:hover { border-color: rgba(201,168,76,0.25); transform: translateY(-2px); }
.how-icon {
    font-size: 1.6rem; display: block; margin-bottom: 0.75rem;
...
.how-title {
    font-family: 'Cormorant Garamond', serif;
    font-size: 1.05rem; font-weight: 600;
    color: #f0ece2; margin-bottom: 0.4rem;
}
...
.stTextInput > div > div > input {
    ...
    border-radius: 10px !important; color: #f0ece2 !important;
    font-family: 'DM Sans', sans-serif !important; font-size: 0.95rem !important;
    padding: 0.75rem 1rem !important; transition: border-color 0.2s, box-shadow 0.2s;
}
.stTextInput > div > div > input:focus {
    border-color: var(--gold) !important;
    box-shadow: 0 0 0 3px rgba(201,168,76,0.11) !important; outline: none !important;
}
.stTextInput > div > div > input::placeholder { color: #3a3a50 !important; }
.stTextInput label {
...
.stFormSubmitButton { width: 100% !important; margin-top: 0.7rem !important; }
.stFormSubmitButton > button {
    display: block !important; width: 100% !important;
    background: linear-gradient(135deg, #9a7510 0%, var(--gold-light) 50%, #9a7510 100%) !important;
    background-size: 200% !important; color: #06090f !important;
    font-family: 'DM Sans', sans-serif !important;
    font-weight: 700 !important; font-size: 0.82rem !important;
    letter-spacing: 0.16em !important; text-transform: uppercase !important;
    border: none !important; border-radius: 10px !important;
    padding: 0.8rem 1.5rem !important; cursor: pointer !important;
...
.testi-text {
    font-size: 0.82rem; color: #9a9690; line-height: 1.65;
...
.chat-bubble-meta {
    font-size: 0.62rem; color: #22223a;
    text-align: right; margin: 0.2rem 0 0;
}
.chat-bubble-ai {
...
.footer-logo {
    font-family: 'Cormorant Garamond', serif;
    font-size: 1.3rem; font-weight: 700; color: rgba(201,168,76,0.4);
...
.stButton > button:hover {
    ...
    color: #774040 !important; background: rgba(180,50,50,0.05) !important;
}
</style>
...
<div class="stats-bar">
    <div class="stat-item">
        ...
        <span class="stat-label">Itineraries crafted</span>
    </div>
    <div class="stat-item">
    ...
    <div class="stat-item">
        ...
        <span class="stat-label">Avg. traveller rating</span>
    </div>
    <div class="stat-item">
        <span class="stat-number">&lt;10s</span>
        <span class="stat-label">Plan generation time</span>
    </div>
</div>
""", unsafe_allow_html=True)
...
destinations = [
    {
        "name": "Kyoto, Japan",
        "img": "https://images.unsplash.com/photo-1545569341-9eb8b30979d9?w=400&q=80",
        "tag": "Culture",
        "meta": "7–10 days · Oct–Nov",
    },
    {
        "name": "Amalfi Coast",
        "img": "https://images.unsplash.com/photo-1612698093158-e07ac200d44e?w=400&q=80",
        "tag": "Scenic",
        "meta": "5–7 days · May–Sep",
    },
    {
        "name": "Bali, Indonesia",
        "img": "https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=400&q=80",
        "tag": "Wellness",
        "meta": "7–14 days · Apr–Oct",
    },
    {
        "name": "Patagonia",
        "img": "https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=400&q=80",
        "tag": "Adventure",
        "meta": "10–14 days · Nov–Mar",
    },
    {
        "name": "Marrakech",
        "img": "https://images.unsplash.com/photo-1539020140153-e479b8c22e70?w=400&q=80",
        "tag": "Culture",
        "meta": "4–6 days · Mar–May",
    },
    {
        "name": "Santorini, Greece",
        "img": "https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?w=400&q=80",
        "tag": "Romance",
        "meta": "4–7 days · Jun–Sep",
    },
]
...
<div class="how-grid">
    <div class="how-card">
        ...
        <div class="how-desc">Type your destination, duration, budget, or travel style — as specific or vague as you like.</div>
    </div>
    <div class="how-card">
        <span class="how-icon">🤖</span>
        <div class="how-step">Step 02</div>
        <div class="how-title">AI crafts your plan</div>
        <div class="how-desc">Our agent researches hotels, attractions, restaurants, transport and weather in real time.</div>
    </div>
    <div class="how-card">
        <span class="how-icon">✈️</span>
        <div class="how-step">Step 03</div>
        <div class="how-title">Pack & go</div>
        <div class="how-desc">Get a day-by-day itinerary with cost breakdowns, tips, and alternatives — ready to use.</div>
    </div>
</div>
""", unsafe_allow_html=True)
...
st.markdown('<p class="section-heading">Plan Your Trip</p>', unsafe_allow_html=True)
st.markdown('<p class="pill-label">Quick start — tap a destination</p>', unsafe_allow_html=True)
